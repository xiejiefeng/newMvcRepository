...
//					return sysReferenceService.resetRedis();
//				}
//			});
//		}
//		
...
//				@Override
//				public boolean invoke() {
//					return referenceService.resetRedis();
//				}
//			});
//		}
//		
...
//				@Override
//				public boolean invoke() {
//					return storeService.resetRedis();
//				}
//			});
//			
//			// 单纯刷新门店时，需刷新美容卡相关缓存
//			if (RedisJobService.REDIS_STORE.equals(redisType)
//					&& result == true) {
//				result = this.handler("美容卡信息", errorMsg, new RedisJobCallBack() {
//					@Override
//					public boolean invoke() {
//						return mrkService.resetRedis();
//					}
//				});
//			}
//		}
...
//				@Override
//				public boolean invoke() {
//					return productService.resetRedis();
//				}
//			});
//		}
//		
...
//				@Override
//				public boolean invoke() {
//					return carModelService.resetRedis();
//				}
//			});
//		}
//		
...
//				@Override
//				public boolean invoke() {
//					return maintenanceService.resetRedis();
//				}
//			});
//		}
//		
...
//				@Override
//				public boolean invoke() {
//					return employeeArtificerService.resetRedis();
//				}
//			});
//		}
//		
...
//				@Override
//				public boolean invoke() {
//					return templateService.resetRedis();
//				}
//			});
//		}
//		
//		if (RedisJobService.REDIS_ALL.equals(redisType)
//				|| RedisJobService.REDIS_MRK.equals(redisType)) {
//			// 刷新美容卡相关缓存
//			result = this.handler("美容卡信息", errorMsg, new RedisJobCallBack() {
//				@Override
//				public boolean invoke() {
