 ...
 * @since [产品/模块版本] （可选）
 */
public class CarModelInfoVo2 implements Serializable{
	...
	// MDM车辆资产ID
 	...
 	// 子属性
 	private List<CarModelInfoVo2> subCarModelList;
	...
	public List<CarModelInfoVo2> getSubCarModelList() {
		return subCarModelList;
	}
	public void setSubCarModelList(List<CarModelInfoVo2> subCarModelList) {
