(function($){
	...
	between:function(s,left, right) {
	 ...
	 $.timeout=10000;
	    ...
	    $.postjson=function(url,data,successfn,arg,completefn){
	        var successfn=successfn||$.noop;
	        $("#loadImg").fadeIn();
	    	$.ajax({
	            url:url,
		...
		$.openLayer= function(content,callback){
			...
			$.closeLayer();
			var _html= '<div class="pop-content-ct"><div class="pop-layer-close-ct" >'
						+'<div  class="pop-layer-close"><i class="iconfont icon-guanbi"></i></div></div> <div class="pop-content">'+content+'</div></div>';
